...
function SignInPage() {
  ...
  return (
    <AuthPage
      ...
      description="browse instead of search. send to put.io. and chill."
    >
      {visibleError ? (
        ...
        <p className="m-0 text-sm leading-relaxed text-stone-700 dark:text-stone-300">
          binge is an independent companion app for put.io users. you bring the put.io account, i
          bring the catalog and the send button. that&apos;s the whole deal.
        </p>
      )}
